...
export default function Navbar() {
  return (
    <>
      <nav className="transition-color duration-200 bg-zinc-50/75 h-20 top-0 right-0 left-0 fixed flex backdrop-blur-sm items-center px-5 justify-between dark:bg-zinc-950/75">
